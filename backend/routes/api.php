...
Route::middleware('auth:api')->group(function () {
    ...
    Route::post('users/{id}/toggle-status', [UserController::class, 'toggleStatus'])->middleware('permission:user.edit');
    Route::post('users/{id}/reset-password', [UserController::class, 'resetPassword'])->middleware('permission:user.edit');
    ...
    Route::post('roles/{id}/permissions', [RoleController::class, 'assignPermissions'])->middleware('permission:role.edit');

    // 权限和设置
    Route::get('permissions', [PermissionController::class, 'index'])->middleware('permission:system.manage');
    Route::get('permissions/all', [PermissionController::class, 'all'])->middleware('permission:system.manage');
    Route::get('settings', [SystemSettingController::class, 'index'])->middleware('permission:system.manage');
    Route::put('settings', [SystemSettingController::class, 'update'])->middleware('permission:system.manage');
    ...
    Route::post('accounts/{id}/toggle-favorite', [AccountController::class, 'toggleFavorite']);
    Route::get('accounts/{id}/password', [AccountController::class, 'getPassword']);
    Route::post('accounts/upload-image', [AccountController::class, 'uploadImage']);
});
